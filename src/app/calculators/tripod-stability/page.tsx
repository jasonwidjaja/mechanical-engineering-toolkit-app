...
export default function TripodStabilityPage() {
  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      <h1 className="text-2xl font-bold text-graphite mb-1">Tripod / Mast Tip-Over Stability</h1>
      <p className="text-graphite/60 text-sm mb-6">
        Factor of safety against overturning —{" "}
        <span className="font-mono bg-panel-gray px-1 rounded">first-pass TIA-222 estimate</span>
      </p>
      ...
      <div className="mt-6 bg-white rounded-lg border border-panel-gray p-5">
        <h3 className="text-sm font-semibold text-graphite/80 mb-2">Notes & Assumptions</h3>
        <ul className="text-xs text-graphite/60 space-y-1.5 list-disc list-inside">
...
function TripodDiagram() {
  return (
    ...
    >
      {/* ── Ground line ── */}
      <line x1="20" y1="190" x2="300" y2="190" stroke="#1A1D21" strokeWidth="2" />

      {/* ── Mast/tower body — gray filled rectangle ── */}
      <rect x="148" y="60" width="24" height="130" fill="#98999B" stroke="#5F6164" strokeWidth="1.5" />

      {/* ── Payload box at top ── */}
      <rect x="138" y="30" width="44" height="30" rx="2" fill="#98999B" stroke="#5F6164" strokeWidth="1.5" />

      {/* ── Tripod left leg ── */}
      <line x1="160" y1="60" x2="80" y2="190" stroke="#5F6164" strokeWidth="2.5" />

      {/* ── Tripod right leg ── */}
      <line x1="160" y1="60" x2="240" y2="190" stroke="#5F6164" strokeWidth="2.5" />

      {/* ── 3rd (center) leg — dotted, visible in side view ── */}
      <line x1="160" y1="60" x2="160" y2="190" stroke="#5F6164" strokeWidth="1.5" strokeDasharray="5 3" />

      {/* ── CG marker — purple × at (160, 100) ── */}
      <text x="160" y="104" textAnchor="middle" fontSize="14" fontWeight="bold" fill="#5F6164">×</text>
      <text x="169" y="100" fontSize="10" fill="#5F6164" fontWeight="600">CG</text>

      {/* ── h_cg dimension — dashed vertical line left side from y=190 to y=100 ── */}
      <line x1="48" y1="190" x2="48" y2="100" stroke="#5F6164" strokeWidth="1" strokeDasharray="4 3" />
      {/* Arrow tip pointing up */}
      <polygon points="48,96 44,106 52,106" fill="#5F6164" />
      {/* Arrow base at ground */}
      <line x1="44" y1="190" x2="52" y2="190" stroke="#5F6164" strokeWidth="1" />
      <text x="10" y="148" fontSize="9" fill="#5F6164" fontWeight="500">h_cg</text>

      {/* ── Wind force arrow — red horizontal from (20,45) to (135,45) ── */}
      {/* Arrowhead pointing right */}
      <line x1="20" y1="45" x2="132" y2="45" stroke="#9B3B3E" strokeWidth="2" />
      <polygon points="138,45 126,40 126,50" fill="#9B3B3E" />
      <text x="55" y="38" fontSize="9" fill="#9B3B3E" fontWeight="600">F_wind</text>

      {/* ── h_wind dimension — vertical dashed line left side from y=190 to y=45 ── */}
      <line x1="28" y1="190" x2="28" y2="48" stroke="#5F6164" strokeWidth="1" strokeDasharray="3 3" />
      <text x="5" y="122" fontSize="9" fill="#5F6164" fontWeight="500">h_wind</text>

      {/* ── Tipping edge — red circle at right foot (240, 190) ── */}
      <circle cx="240" cy="190" r="6" fill="none" stroke="#9B3B3E" strokeWidth="2" />
      <text x="215" y="207" fontSize="8" fill="#9B3B3E" fontWeight="500">tipping edge</text>

      {/* ── d dimension — double-headed arrow from x=160 to x=240 at y=203 ── */}
      <line x1="160" y1="203" x2="240" y2="203" stroke="#5F6164" strokeWidth="1" />
      {/* Left arrowhead */}
      <polygon points="160,203 170,199 170,207" fill="#5F6164" />
      {/* Right arrowhead */}
      <polygon points="240,203 230,199 230,207" fill="#5F6164" />
      <text x="193" y="215" fontSize="9" fill="#5F6164" fontWeight="500">d</text>
    </svg>
  );
}
